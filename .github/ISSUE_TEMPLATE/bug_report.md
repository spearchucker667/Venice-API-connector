---
name: Bug report
about: Report a reproducible Venice Forge problem
labels: bug
---
...
Paste sanitized diagnostics from the Status tab. Do not include API keys, bearer tokens, `.env` contents, certificates, or private logs.
