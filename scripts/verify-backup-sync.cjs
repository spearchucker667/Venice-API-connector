...
function runStaticChecks() {
  ...
  mustContain(SYNC_HANDLERS_FILE, "electron/ipc/handlers/syncHandlers.ts channels", [
    'registerPrivilegedIpcChannel("sync:chooseSyncFolder"',
    'registerPrivilegedIpcChannel("sync:getSyncFolder"',
    'registerPrivilegedIpcChannel("sync:startSync"',
    'registerPrivilegedIpcChannel("sync:stopSync"',
    'registerPrivilegedIpcChannel("sync:pauseSync"',
    'registerPrivilegedIpcChannel("sync:getStatus"',
    'registerPrivilegedIpcChannel("sync:setEmissionSuppressed"',
    'registerPrivilegedIpcChannel("sync:writePacket"',
    'registerPrivilegedIpcChannel("sync:encryptBackup"',
    'registerPrivilegedIpcChannel("sync:decryptBackup"',
    'registerPrivilegedIpcChannel("sync:createReplaceImportRecovery"',
    'registerPrivilegedIpcChannel("sync:getLatestReplaceImportRecovery"',
    'registerPrivilegedIpcChannel("sync:loadReplaceImportRecovery"',
    'registerPrivilegedIpcChannel("sync:applyRemoteMutation"',
