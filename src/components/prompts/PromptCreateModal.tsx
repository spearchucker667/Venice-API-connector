    ...
    >
        ...
        >
          <div>
            ...
            <input
              ...
              className="w-full bg-background border border-border rounded-md px-3 py-2 text-[13px] focus:border-accent"
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full bg-background border border-border rounded-md px-3 py-2 text-[13px] font-mono focus:border-accent resize-y min-h-[100px]"
              placeholder={tRuntime(
          ...
          {(kind === "image" || kind === "recipe" || kind === "general") && (
            <div>
              ...
              <textarea
                ...
                rows={2}
                className="w-full bg-background border border-border rounded-md px-3 py-2 text-[13px] font-mono focus:border-accent resize-y min-h-[60px]"
                placeholder={tRuntime(
      ...
      <div className="px-5 py-4 border-t border-border/50 flex justify-end gap-3 bg-surface-elevated/30">
        <button
          ...
          className="px-4 py-2 text-[12.5px] rounded-md border border-border text-text-secondary hover:text-text-primary"
        >
        ...
        <button
          ...
          className="px-4 py-2 text-[12.5px] rounded-md bg-accent text-accent-fg hover:bg-accent-hover disabled:opacity-50 font-medium"
        >
