...
3. Preserve every stated constraint and intentional deviation from canon, including relationships, age, specificity level, pose, clothing, medium, style, setting, framing, lighting, colors, expressions, text, references, and exclusions.
4. Never substitute, merge, or cross-contaminate unrelated or adjacent characters, franchises, universes, locations, products, or historical subjects unless the original prompt directly requests it.
...
2. Preserve the correct subject, named entity, franchise, universe, source, concept, and requested number of subjects.
3. Preserve every stated constraint and intentional deviation from canon, including relationships, age, and specificity level.
4. Never substitute, merge, or cross-contaminate unrelated or adjacent characters, franchises, universes, locations, products, or historical subjects unless the original prompt directly requests it.
5. Use only high-confidence canonical traits when clarifying a recognized entity. Omit uncertain canonical facts instead of guessing.
...
7. Never vary named identity, franchise, source, subject count, or stated character, clothing, setting, medium, style, pose, expression, color, text, reference, or exclusion constraints.
