...
describe("Phase 9 — isProductionComplete derives from status JSON", () => {
  ...
  it("source language is complete after runtime-surface debt reaches zero", () => {
    expect(LOCALE_COMPLETION["en-US"].catalogStructuralCoverage).toBe(100);
    expect(LOCALE_COMPLETION["en-US"].runtimeSurfaceCoverage).toBe(100);
