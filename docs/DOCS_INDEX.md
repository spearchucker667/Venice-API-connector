...
- [reports/MEDIA_PREVIEW_TRAFFIC_INSPECTOR_REMEDIATION_REPORT_2026-07-26.md](reports/MEDIA_PREVIEW_TRAFFIC_INSPECTOR_REMEDIATION_REPORT_2026-07-26.md) — Closure report for the Media Preview + Traffic Inspector remediation work order (Phases A–D): durable image source resolver, legacy `venice()` consolidation, cross-process Inspector telemetry contract chain, and Inspector pane capture-state pill + live request counter (under the `VF-MEDIA-PREVIEW-TRAFFIC-INSPECTOR-001` roadmap row).
