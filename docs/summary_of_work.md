...
**Validation:** `lint:eslint` (0 warnings, `--max-warnings=0`), `typecheck` (both tsconfig pipelines), gallery tests 63/63, media-export-bundle tests 21/21, media-inspector tests 13/13. Test `gallery-view.test.tsx:390` updated to match new image-file export behavior with mocked `fetch` for data URLs.
